...
extern NSString* const SYMM_NOTIF_HIDE_GRID_MENU;
...
extern NSString* const SYMM_NOTIF_PERFORM_OPEN_IMG;
extern NSString* const SYMM_NOTIF_PERFORM_DEL;
extern NSString* const SYMM_NOTIF_PERFORM_DEL_IMG;
extern NSString* const SYMM_NOTIF_PERFORM_ADD_IMG;
extern NSString* const SYMM_NOTIF_DRAWING_STARTED;
extern NSString* const SYMM_NOTIF_DRAWING_FINISHED;
...
extern NSString* const SYMM_NOTIF_SHARE;
...
extern NSString* const SYMM_NOTIF_IMG_LOADED;
