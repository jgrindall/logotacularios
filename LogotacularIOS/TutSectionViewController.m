...
- (void) addButton{
	...
	[self.progCopyButton setTitle:@"Open file" forState:UIControlStateNormal];
	[self.progCopyButton setImage:[UIImage imageNamed:ADD_ICON] forState:UIControlStateNormal];
	self.progCopyButton.imageEdgeInsets = UIEdgeInsetsMake(0, 126, 0, 0);
