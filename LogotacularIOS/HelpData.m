...
NSString* const STYLES = @"<style>h1, p, h2, h3, div, span{font-family: 'Lato-Regular';font-size: 24px;color:white}p{font-size: 19px;}p.code, pre{font-family:'DroidSansMono', font-size: 48px !important;color:white}p.quote{font-size: 14px;}</style>";
