...
NSString* const CHAR1_ICON =		@"assets/icons/char1.png";
NSString* const CHAR2_ICON =		@"assets/icons/char2.png";
NSString* const CHAR3_ICON =		@"assets/icons/char3.png";
